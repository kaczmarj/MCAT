...
def main(args):
    ...
    for i in folds:
        ...
        if (
            "omic" in args.mode
            or args.mode == "cluster"
            or args.mode == "graph"
            or args.mode == "pyramid"
        ):
...
parser.add_argument(
    "--model_type",
    type=str,
    choices=["snn", "deepset", "amil", "mi_fcn", "mcat"],
    default="mcat",
...
parser.add_argument(
    "--drop_out", action="store_true", default=True, help="Enable dropout (p=0.25)"
)
parser.add_argument(
    "--model_size_wsi", type=str, default="small", help="Network size of AMIL model"
)
parser.add_argument(
    "--model_size_omic", type=str, default="small", help="Network size of SNN model"
)
...
parser.add_argument(
    "--lr", type=float, default=2e-4, help="Learning rate (default: 0.0001)"
)
parser.add_argument(
    "--bag_loss",
    type=str,
